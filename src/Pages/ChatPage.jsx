...
const ChatPage = () => {
  ...
  if (loading) {
    return (
      // Changed to return main content directly, Navbar is in App.jsx
  ...
  if (error) {
    return (
      // Changed to return main content directly
  ...
  // Main chat interface
  return (
    // Changed main div to be a flex container for chat structure
    <div className="flex flex-col h-[calc(100vh-theme(spacing.16))]"> {/* Adjust height based on Navbar height */}
      ...
      <div className="flex-1 p-4 md:p-6 overflow-y-auto space-y-4 bg-gray-100">
        {messages.length === 0 ? (
